                ...
                <div class="card-body py-3 p-0">
                    <div class="row">
                        ...
                        <div class="col-lg-6 pl-lg-4 mt-lg-0 mt-4">
                            <img src="../public/images/template2.jpg" alt="" class="img-fluid rounded" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body py-3 p-0">
                    <div class="row">
                        <div class="col-lg-6 pr-lg-4">
                            <img src="../public/images/template1.jpg" alt="" class="img-fluid rounded" />
                        </div>
                ...
                <div class="card-body py-3 p-0">
                    ...
                    <div class="row cwp23-content">
                        ...
                        <div class="col-md-6 mt-md-0 mt-5 cwp23-img">
                            <img src="../public/images/template2.jpg" class="img-fluid rounded" alt="" />
                        </div>
                    </div>
                </div>
            </div>
